...
description: Multi-platform contacts, AI-powered enrichment, smart pruning, and the golden record that unifies your relationships across X, LinkedIn, and Gmail.
order: 2
---
...
![Contacts list — your unified contact directory](/assets/guide/contacts-list.png)
...
![Contact detail — complete profile with identities and tasks](/assets/guide/contact-detail.png)
...
![Automation dashboard — agent gallery with Enrich category](/assets/guide/automation-dashboard.png)
...
Both agents show estimated cost (~$0.50 per run), run count, and last execution time on their cards. Click **Run** to activate, or schedule them to run on a recurring basis (see [AI Agents and Automation](/guide/04-ai-agents-and-automation/)).
...
**Next: [Content and Publishing](/guide/03-content-and-publishing/)** — Write posts, generate AI drafts, and publish to X and LinkedIn directly from your CRM.

**Also see: [AI Agents and Automation](/guide/04-ai-agents-and-automation/)** — Deep dive into how enrichment agents work under the hood.
