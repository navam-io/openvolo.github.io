...
description: From zero to a running CRM in under a minute. Installation, API keys, platform connections, and your first dashboard tour.
order: 1
---
...
![Settings page — API keys and platform connections](/assets/guide/settings-page.png)
...
![Help page — setup checklist and documentation](/assets/guide/help-page.png)
...
![Dashboard overview — your CRM at a glance](/assets/guide/dashboard-overview.png)
...
**Next: [Contacts and Enrichment](/guide/02-contacts-and-enrichment/)** — Import contacts from X and LinkedIn, understand enrichment scores, and let AI fill in the gaps.
