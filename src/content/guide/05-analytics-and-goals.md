...
description: Five-tab analytics dashboard, goal-driven demand generation with auto-progress tracking, and linked workflows that feed measurable targets.
order: 5
---
...
![Analytics dashboard — five tabs of CRM intelligence](/assets/guide/analytics-dashboard.png)
...
![Goals list — track demand generation targets](/assets/guide/goals-list.png)
...
![Goal detail — progress tracking with linked workflows](/assets/guide/goal-detail.png)
...
**Next: [AI Chat Assistant](/guide/06-ai-chat-assistant/)** — Query analytics, check goal progress, and manage your entire CRM through natural language.
