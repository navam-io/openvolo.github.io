...
description: Agent gallery with 10 pre-built agents, workflow execution, cron scheduling, step-level observability, and the agent toolset architecture.
order: 4
---
...
![Automation dashboard — 10 pre-built agents across 6 categories](/assets/guide/automation-dashboard.png)
...
![Workflow detail — step-by-step timeline of an agent run](/assets/guide/workflow-detail.png)
...
![Chat panel — triggering workflows conversationally](/assets/guide/chat-panel.png)
...
**Next: [Analytics and Goals](/guide/05-analytics-and-goals/)** — Track agent performance, contact growth, and set demand generation targets.

**Also see: [AI Chat Assistant](/guide/06-ai-chat-assistant/)** — Trigger and monitor agents through natural language.
