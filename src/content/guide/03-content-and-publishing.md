...
description: Content library, AI-assisted writing with Draft/Suggest/Refine modes, cross-platform adaptation, and browser-based publishing to X and LinkedIn.
order: 3
---
...
![Content library — browse and manage content across platforms](/assets/guide/content-library.png)
...
![Compose dialog — write and publish posts with platform controls](/assets/guide/compose-dialog.png)
...
![AI Assist panel — generate drafts, get suggestions, refine your writing](/assets/guide/ai-assist-panel.png)
...
![Content detail — individual content item with metadata](/assets/guide/content-detail.png)
...
**Next: [AI Agents and Automation](/guide/04-ai-agents-and-automation/)** — Deploy agents for search, enrichment, content creation, and engagement.

**Also see: [Analytics and Goals](/guide/05-analytics-and-goals/)** — Track content performance and set publishing goals.
