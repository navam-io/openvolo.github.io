...
description: Natural language CRM interface with smart prompts, 9 CRM tools, multi-step tool chains, and conversation history for managing your entire CRM conversationally.
order: 6
---
...
![Chat panel — CRM Assistant with smart prompts](/assets/guide/chat-panel.png)
...
![Dashboard with chat panel — the full OpenVolo experience](/assets/guide/dashboard-overview.png)
...
1. [Getting Started](/guide/01-getting-started/) — Installation, API keys, platform connections
2. [Contacts and Enrichment](/guide/02-contacts-and-enrichment/) — Multi-platform contacts and AI enrichment
3. [Content and Publishing](/guide/03-content-and-publishing/) — Content library, AI writing, browser publishing
4. [AI Agents and Automation](/guide/04-ai-agents-and-automation/) — Agent gallery, execution, scheduling
5. [Analytics and Goals](/guide/05-analytics-and-goals/) — Dashboard analytics and demand generation goals
6. [AI Chat Assistant](/guide/06-ai-chat-assistant/) — Natural language CRM interface *(you are here)*

**Back to: [OpenVolo User Guide](/guide/)**
