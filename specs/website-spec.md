...
├── #features     → 6 feature cards in glass grid
...
- **Subheadline**: "Manage contacts, content, and engagement across X, LinkedIn, and Gmail — powered by Claude AI agents. All data stays on your machine."
...
- **Grid**: 3×2 responsive (1col mobile → 2col tablet → 3col desktop)
...
3. **Unified Contacts** (Users icon) — "Cross-platform contact management with automatic deduplication and enrichment scoring."
4. **AI Agents** (Bot icon) — "Claude AI agents automate engagement, enrichment, and outreach workflows."
5. **Multi-Platform Publishing** (Share icon) — "Compose, schedule, and publish across X, LinkedIn, and Gmail from one dashboard."
6. **Smart Data** (BarChart icon) — "Engagement metrics, funnel tracking, and AI-powered contact enrichment."
...
- **Steps**:
  ...
  3. **Automate** — "Let AI agents manage engagement, enrich contacts, and grow your network while you focus on what matters."
...
- **Badges**: Next.js 16, React 19, TypeScript, SQLite, Drizzle ORM, Claude SDK, Tailwind CSS 4, Vitest
...
- **Questions**:
  ...
  3. "Do I need API keys?" → "You need an Anthropic API key for AI features. Platform API keys (X, LinkedIn, Gmail) are optional — only needed for the platforms you want to connect."
  4. "What platforms are supported?" → "X/Twitter, LinkedIn, and Gmail are fully supported. Substack integration is on the roadmap."
  5. "Can I use it with Claude Code?" → "Yes. OpenVolo works with Claude Code Max, Claude Code Pro, or a standard Anthropic API key."
